...
from data.preprocessors import preprocess_median_gaussian_vgg
...
preprocess_fn = lambda x: preprocess_median_gaussian_vgg(
    x,
    use_denoise=True,
    median_size=3,
    gaussian_kernel=5,
...
train_gen, val_gen = get_training_data(config["dataset_path"], 4)
...
checkpoint_TRADES_model_dir = config["checkpoint_dir"] + "[Best_checkpoint]TRADES_model_04112025_2128_GaussianMedian.h5"
final_TRADES_model_dir = config["final_model_dir"] + "[Final]TRADES_model_04112025_2128_GaussianMedian.h5"
